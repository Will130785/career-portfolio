...
},{"_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"../src/js/navbar-scroll.js":[function(require,module,exports) {
"use strict";
...
},{}],"../src/js/animation.js":[function(require,module,exports) {
"use strict";
...
exports.tabs = tabs;
},{}],"../src/js/hamburger.js":[function(require,module,exports) {
"use strict";
...
exports.modal = modal;
},{}],"../src/js/color-game.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.colorGame = void 0;

var colorGame = function colorGame() {
  //UI variables
  var colorDisplay = document.querySelector("#color-display");
  var newColors = document.querySelector(".new-colors");
  var circles = document.querySelectorAll(".circle");
  var gameContainer = document.querySelector(".education__game"); //Gameplay variables

  var colors = [];
  var pickedColor;
  var gameover = false; //Place colors on circles

  var placeColors = function placeColors() {
  ...
  var generateRandomColors = function generateRandomColors() {
  ...
  var getRandomColors = function getRandomColors() {
...
},{"../core-js/promise":"../node_modules/@babel/runtime-corejs2/core-js/promise.js"}],"../node_modules/@babel/runtime-corejs2/helpers/classCallCheck.js":[function(require,module,exports) {
...
},{"../core-js/object/define-property":"../node_modules/@babel/runtime-corejs2/core-js/object/define-property.js"}],"../src/js/weather.js":[function(require,module,exports) {
"use strict";
...
var getWeather = function getWeather() {
  ...
  var Weather = /*#__PURE__*/function () {
    ...
    (0, _createClass2.default)(Weather, [{
      key: "getWeather",
      value: function () {
        var _getWeather = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee(search) {
          ...
          return _regenerator.default.wrap(function _callee$(_context) {
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  _context.next = 2;
                  return fetch("https://api.weatherapi.com/v1/current.json?key=e278f6dd081648039c284643202104&q=".concat(search));
  ...
  var weather = new Weather(); //Create UI variables

  var searchBtn = document.querySelector(".weather-btn");
  var searchInput = document.querySelector(".weather-search");
  var country = document.querySelector(".country-info");
  ...
  var windDirection = document.querySelector(".wind-direction-info");
...
},{"@babel/runtime-corejs2/regenerator":"../node_modules/@babel/runtime-corejs2/regenerator/index.js","@babel/runtime-corejs2/helpers/asyncToGenerator":"../node_modules/@babel/runtime-corejs2/helpers/asyncToGenerator.js","@babel/runtime-corejs2/helpers/classCallCheck":"../node_modules/@babel/runtime-corejs2/helpers/classCallCheck.js","@babel/runtime-corejs2/helpers/createClass":"../node_modules/@babel/runtime-corejs2/helpers/createClass.js"}],"../src/js/app.js":[function(require,module,exports) {
"use strict";

require("../scss/main.scss");

var _navbarScroll = require("./navbar-scroll");
...
(0, _navbarScroll.scrollEffect)(); //Execute landing section animation

(0, _animation.animation)(); //Execute event listeners for tabs
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "54421" + '/');
